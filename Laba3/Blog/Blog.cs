...
namespace Laba3
{
    internal class Blog
    {
        ...
        public Blog()
        {
            ...
            {
                new Report("Морковь"," - двулетнее растение (редко одно- или многолетнее) из семейства Зонтичные" , 5),
                new Report("Лук"," - многолетнее травянистое растение, вид рода Лук (Allium) семейства Луковые", -2),
